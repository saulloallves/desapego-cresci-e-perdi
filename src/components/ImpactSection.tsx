      ...
      <div className="container mx-auto px-4">
        ...
        <div ref={titleRef} className="max-w-4xl mx-auto text-center mb-16">
          ...
          >
            <p className="text-lg md:text-xl leading-relaxed">
              Ao desapegar com a Cresci e Perdi, você ajuda outras famílias a
              acessarem produtos de qualidade, com economia e sem abrir mão de
              bons materiais para seus filhos. O desapego vai além do simples
              ato de "deixar ir", ele é um ato de generosidade, que envolve a
              solidariedade de compartilhar o que já não serve mais para alguém
              que precisa.
            </p>
          </div>
        </div>
        ...
        */}
        ...
        <div ref={finalRef} className="max-w-4xl mx-auto text-center">
          <div
            className={`bg-gradient-to-br from-accent/20 to-secondary/20 rounded-3xl p-8 md:p-12 shadow-lg border-2 border-accent/30 transition-all duration-700 ${
          ...
          >
            ...
            <p className="text-2xl md:text-3xl font-display text-primary my-6">
            ...
            <LeadFormDialog
                  ...
                  trigger={
                    <Button
                      size="lg"
                      className="font-black bg-secondary hover:bg-secondary/90 text-primary-foreground font-display ml-5 text-2xl md:text-3xl px-12 py-8 h-auto rounded-full shadow-[var(--shadow-strong)] hover:scale-105 transition-transform transform"
                    >
                      CLIQUE AQUI!
                    </Button>
                  }
